...
final class PostBookingRX extends RxResponseInt<Map> {
  final api = PostBookingApi.instance;

  PostBookingRX({required super.empty, required super.dataFetcher});

  ValueStream get getserrviceCreateData => dataFetcher.stream;

  String message = "";

  Future<void> booking(int id, Map body) async {
    try {
      Map data = await api.booking(body: body, id: id);
      // .waitingForFuture();
