...
final class PostCustomerGiveReviewRX extends RxResponseInt<Map> {
  final api = PostCustomerGiveReviewApi.instance;

  PostCustomerGiveReviewRX({required super.empty, required super.dataFetcher});

  ValueStream get getserrviceCreateData => dataFetcher.stream;

  String message = "";

  Future<void> giveReview(Map body) async {
    try {
      Map data = await api.giveReview(body: body);
      // .waitingForFuture();
