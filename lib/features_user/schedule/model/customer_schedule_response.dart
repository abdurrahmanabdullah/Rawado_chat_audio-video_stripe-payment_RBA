...
class CustomerScheduleResponse {
    bool? status;
    String? message;
    int? code;
    List<CustomerScheduleData>? data;
    ...
    CustomerScheduleResponse copyWith({
        bool? status,
        String? message,
        int? code,
        List<CustomerScheduleData>? data,
    ...
    factory CustomerScheduleResponse.fromRawJson(String str) => CustomerScheduleResponse.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory CustomerScheduleResponse.fromJson(Map<String, dynamic> json) => CustomerScheduleResponse(
        status: json["status"],
        message: json["message"],
        code: json["code"],
        data: json["data"] == null ? [] : List<CustomerScheduleData>.from(json["data"]!.map((x) => CustomerScheduleData.fromJson(x))),
    );
...
class CustomerScheduleData {
    ...
    factory CustomerScheduleData.fromRawJson(String str) => CustomerScheduleData.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory CustomerScheduleData.fromJson(Map<String, dynamic> json) => CustomerScheduleData(
        id: json["id"],
