...
final class PostTrainerRcheduleActionRX extends RxResponseInt {
  final api = PostTrainerRescheduleActionApi.instance;

  PostTrainerRcheduleActionRX(
  ...
  Future<void> changeReschedulStatus(int id) async {
    try {
      Map data = await api.changeRescheduleStatus(id: id);
      // .waitingForFuture();
