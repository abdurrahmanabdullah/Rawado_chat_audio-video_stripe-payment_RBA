...
final class PostTrainerServiceCompleteRX extends RxResponseInt {
  final api = PostTrainerServiceCompleteApi.instance;

  PostTrainerServiceCompleteRX(
  ...
  Future<void> completeService(int id) async {
    try {
      Map data = await api.completeService(id: id);
      // .waitingForFuture();
